...
class BooksRepository {
  ...
  static final List<BookModel> prebuiltLibrary = [
    ...
    BookModel(
      ...
      chapters: [
        ...
        const BookChapter(
          title: 'Chapter 2: Call to Testify La ilaha illallah',
          content:
              'Inviting people to the oneness of Allah is the path of all Prophets. The Prophet (ﷺ) told Mu\'adh when sending him to Yemen: "Let the first thing to which you invite them be the worship of Allah alone."',
        ),
      ],
    ),
    BookModel(
      ...
      chapters: [
        ...
        const BookChapter(
          title: 'Exegesis of Ayat al-Kursi (2:255)',
          content:
              'Ayat al-Kursi is the greatest verse in the Book of Allah. The Prophet (ﷺ) asked Ubayy bin Ka\'b: "Which verse in the Book of Allah is the greatest?" He replied: "Allah! There is no deity except Him, the Ever-Living, the Sustainer of existence."',
        ),
      ],
    ),
    BookModel(
    ...
    BookModel(
      ...
      chapters: [
        ...
        const BookChapter(
          ...
          content:
              'Ibrahim (AS) is Khalilullah (the Intimate Friend of Allah) and the father of Prophets who stood firmly for Tawheed against idolatry.',
        ),
      ],
    ),
  ];
  ...
  static Future<List<BookModel>> getUserBooks() async {
    ...
    if (rawJson == null || rawJson.isEmpty) {
      // Default initial books: Add Hisnul Muslim, Riyad as-Salihin, Forty Hadith, and Sealed Nectar
      final defaultUserBooks = [
        prebuiltLibrary[0], // Riyad as-Salihin
        prebuiltLibrary[1], // Hisnul Muslim
        prebuiltLibrary[2], // Sealed Nectar
        prebuiltLibrary[3], // Forty Hadith
      ];
    ...
    try {
      ...
      return prebuiltLibrary.take(4).toList();
    }
  }
