...
class _TasbeehLibraryModalState extends State<TasbeehLibraryModal> {
  ...
  void _showFloatingToast(String text, {required bool isPinned}) {
            ...
            child: TweenAnimationBuilder<double>(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isPinned ? const Color(0xFF2A531D) : const Color(0xFF334155),
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                      isPinned ? Icons.check_circle_rounded : Icons.remove_circle_outline_rounded,
                      color: Colors.white,
                      size: 18,
                    ),
  ...
  void _toggleItem(TasbeehItem item) {
    ...
    if (isPinned) {
      ...
      _showFloatingToast('Unpinned', isPinned: false);
    } else {
      widget.onAddItem(item);
      setState(() {
        _activeItems.add(item);
      });
      _showFloatingToast('Pinned', isPinned: true);
    }
  }
