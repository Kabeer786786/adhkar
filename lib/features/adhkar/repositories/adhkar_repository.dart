...
class AdhkarRepository {
  ...
  List<AdhkarCategory> getDefaultCategories() {
    return const [
      AdhkarCategory(
        ...
        subtitle: 'Duas & Adhkar to read after Fajr until sunrise for protection & peace.',
      ...
      AdhkarCategory(
        ...
        subtitle: 'Evening Duas & Adhkar for peace, protection and divine blessings.',
      ...
      AdhkarCategory(
        id: 'duas',
        title: 'Daily Duas',
        subtitle: 'Comprehensive Quranic and Sunnah Duas & Adhkar for daily life.',
        titleAr: 'أدعية يومية',
  ...
  static const List<DhikrItem> _morningAdhkar = [
    DhikrItem(
      ...
      translation: 'We have reached the morning and at this very time all sovereignty belongs to Allah, praise is for Allah. None has the right to be worshipped except Allah alone.',
      reference: 'Muslim 4/2088',
      virtue: 'Whosoever recites this in the morning will be granted protection and peace throughout the day.',
      countTarget: 1,
    ),
    DhikrItem(
      id: 'm2',
      ...
      translation: 'O Allah, by Your leave we reach the morning and by Your leave we reach the evening, by Your leave we live and die and unto You is our resurrection.',
      reference: 'Tirmidhi 3/142',
      virtue: 'Expresses total reliance and submission to Allah at the start of the day.',
      countTarget: 1,
    ),
    DhikrItem(
      id: 'm3',
      ...
      translation: 'O Allah, You are my Lord, none has the right to be worshipped except You. You created me and I am Your servant, and I abide by Your covenant.',
      reference: 'Sayyid al-Istighfar (Bukhari 7/150)',
      virtue: 'If recited during the day with firm belief and one dies that day, he will enter Paradise.',
      countTarget: 1,
    ),
    DhikrItem(
      id: 'm4',
      ...
      translation: 'Glory is to Allah and praise is to Him, by the number of His creation and His pleasure, and by the weight of His Throne.',
      reference: 'Muslim 4/2090',
      virtue: 'Recompensed with reward heavier than all morning Adhkar combined.',
      countTarget: 3,
    ),
    DhikrItem(
      id: 'm5',
      ...
      virtue: 'Whoever recites it three times in the morning will not be afflicted by any sudden calamity until evening.',
      countTarget: 3,
    ),
  ];
  ...
  static const List<DhikrItem> _eveningAdhkar = [
    DhikrItem(
      ...
      translation: 'We have reached the evening and at this very time all sovereignty belongs to Allah, praise is for Allah.',
      reference: 'Muslim 4/2088',
    ...
    DhikrItem(
      ...
      virtue: 'Whoever recites it three times in the evening will not be harmed by any creature during that night.',
      countTarget: 3,
    ),
  ];
  ...
  static const List<DhikrItem> _afterSalahAdhkar = [
    DhikrItem(
      ...
      translation: 'I seek forgiveness from Allah. O Allah, You are As-Salam (Peace) and from You is peace. Blessed are You, O Owner of Majesty and Honor.',
    ...
    DhikrItem(
      id: 's2',
      category: 'salah',
      arabicText: 'سُبْحَانَ اللَّهِ (33)، الْحَمْدُ لِلَّهِ (33)، اللَّهُ أَكْبَرُ (33)، لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ',
      transliteration: 'SubhanAllah (33x), Alhamdulillah (33x), Allahu Akbar (33x), La ilaha illallahu wahdahu la shareeka lah...',
      translation: 'Glory to Allah (33), Praise to Allah (33), Allah is the Greatest (33). None has the right to be worshipped except Allah alone.',
      reference: 'Muslim 1/418',
      virtue: 'Sins will be forgiven even if they were like the foam of the sea.',
      countTarget: 99,
    ),
  ];
  ...
  static const List<DhikrItem> _sleepAdhkar = [
    DhikrItem(
      id: 'sl1',
      category: 'sleep',
      arabicText: 'بِاسْمِكَ رَبِّي وَضَعْتُ جَنْبِي، وَبِاسْمِكَ أَرْفَعُهُ، فَإِنْ أَمْسَكْتَ نَفْسِي فَارْحَمْهَا، وَإِنْ أَرْسَلْتَهَا فَاحْفَظْهَا',
      transliteration: 'Bismika Rabbee wada\'tu janbee, wa bismika arfa\'uh, fa-in amsakta nafsee farhamha...',
      translation: 'In Your name my Lord, I lie down, and in Your name I rise. If You take my soul, have mercy upon it, and if You release it, protect it.',
